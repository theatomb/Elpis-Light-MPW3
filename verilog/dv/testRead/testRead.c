...
void main()
{
	...
	USER_DATA[1] = 0x00700073;
	USER_DATA[2] = 0x004007af;
	USER_DATA[3] = 0x00000033;
	USER_DATA[4] = 0x00000033;
	USER_DATA[5] = 0xFFFFFFFF;

	uint32_t USER_ADDR[6];
	USER_ADDR[0] = 0x00000040;
	USER_ADDR[1] = 0x00000041;
	USER_ADDR[2] = 0x00000042;
	USER_ADDR[3] = 0x00000043;
	USER_ADDR[4] = 0x00000044;
	USER_ADDR[5] = 0xFFFFFFFF;
